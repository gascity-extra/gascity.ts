  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // In react-day-picker v10 the day-grid class is `month_grid` (the v9
        // `table` key was removed). The visual contract is the same: the
        // `<table>` element renders the month grid.
