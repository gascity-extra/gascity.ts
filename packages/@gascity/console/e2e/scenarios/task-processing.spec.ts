...
test.describe('Task Processing Automation', () => {
  ...
  test('scenario: simple task → automatic completion', async ({ page }) => {
  ...
  test('scenario: task with dependencies → sequential processing', async ({ page }) => {
  ...
  test('scenario: long-running task → session persistence', async ({ page }) => {
  ...
  test('scenario: multiple tasks → concurrent processing', async ({ page }) => {
  ...
  test('scenario: task error handling → failure recovery', async ({ page }) => {
  ...
  test('scenario: task with mail notification → communication flow', async ({ page }) => {
    // Create a task
    await actions.slingTask(
      'default',
      'default',
  ...
  test('scenario: task → formula execution → automated workflow', async ({ page }) => {
  ...
  test('scenario: task → order trigger → scheduled automation', async ({ page }) => {
